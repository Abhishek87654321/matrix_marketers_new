...
class TendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tender" do
    assert_difference("Tender.count") do
      post tenders_url, params: { tender: { description: @tender.description, status: @tender.status, submission_date: @tender.submission_date, title: @tender.title } }
    end
  ...
  test "should update tender" do
    patch tender_url(@tender), params: { tender: { description: @tender.description, status: @tender.status, submission_date: @tender.submission_date, title: @tender.title } }
